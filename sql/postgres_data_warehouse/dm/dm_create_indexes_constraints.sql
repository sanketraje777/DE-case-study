...
BEGIN
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_pkey 
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_order_total_check 
                CHECK (order_total >= 0);
    EXCEPTION WHEN OTHERS THEN
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_total_qty_ordered_check 
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_customer_gender_check 
                CHECK (customer_gender IN ('Female', 'Male'));
    EXCEPTION WHEN OTHERS THEN
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_item_price_check 
                CHECK (item_price >= 0);
    EXCEPTION WHEN OTHERS THEN
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_item_qty_order_check 
                CHECK (item_qty_order >= 0);
    EXCEPTION WHEN OTHERS THEN
    ...
    BEGIN
        ALTER TABLE dm.sales_order_item_flat 
            ADD CONSTRAINT sales_order_item_flat_item_unit_total_check 
                CHECK (item_unit_total >= 0);
    EXCEPTION WHEN OTHERS THEN
