...
BEGIN
  WHILE inner_offset < outer_limit LOOP
    ...
    WITH raw_page AS NOT MATERIALIZED (
    SELECT
        product_id,
        product_sku,
        product_name,
    ...
    cleaned_raw_page AS NOT MATERIALIZED (
      SELECT 
        product_id,
        TRIM(product_sku),
        TRIM(product_name)
    ...
    sku_ranked AS NOT MATERIALIZED (
    SELECT
        product_id,
        product_sku,
        product_name,
    ...
    deduped_product AS NOT MATERIALIZED (
    SELECT 
      product_id, 
