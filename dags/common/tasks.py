...
from common.utils import (
    ...
    has_psycopg2_placeholders, is_sane, zip_dictionaries, fetch_all, 
...
@task.branch
def check_sanity(*values, **kwargs):
    route_valid = kwargs.get("route_valid", None)
    route_invalid = kwargs.get("route_invalid", None)
    evaluation = kwargs.get("evaluation", lambda *values: all(values))
    return is_sane(*values, 
                   success_val=route_valid, 
                   failure_val=route_invalid,
