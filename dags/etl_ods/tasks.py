...
with DAG(
    ...
    # 1️⃣ Ensure ODS schemas and constraint tables exist
    ...
    # 2️⃣ Load products (dedupe on sku)
    ...
    # 3️⃣ Load customers (clean email + null filtering + dedupe)
    ...
    # 4️⃣ Load orders (ensure referential integrity)
    ...
    # 5️⃣ Load order items (map product and order FKs)
    ...
    # 6️⃣ Mark last load timestamp (audit/log)
