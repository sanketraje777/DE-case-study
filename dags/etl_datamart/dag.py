...
with DAG(
    ...
    init_dm = EmptyOperator(task_id="init_dm")
    end_dm = EmptyOperator(task_id="end_dm")
    ...
    target_table = "sales_order_item_flat"
    source_tables = ["salesorderitem","salesorder","customer","product"]
    with TaskGroup(f"tg_{target_table}") as tg_salesorderitemflat:
        truncate_target_salesorderitemflat = PostgresOperator(
