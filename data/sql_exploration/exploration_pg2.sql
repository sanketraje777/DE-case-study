...
BEGIN
  WHILE inner_offset < outer_limit LOOP
    ...
    raw_page AS (
      SELECT *
      FROM lz.salesorderitem   -- lz.salesorderitem
    ...
    WHILE start_idx <= total_rows LOOP
      ...
      INSERT INTO ods.salesorderitem (    -- ods.salesorderitem
        item_id, order_id, product_id,
        qty_ordered, price, line_total,
        created_at, modified_at
      )
      ...
      WHERE
        (ods.salesorderitem.order_id,   -- ods.salesorderitem.order_id
